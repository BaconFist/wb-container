...
$MESSAGE['SIGNUP_NO_DISPLAY_NAME'] = 'Bitte geben Sie einen Anzeige Namen an';
...
$MESSAGE['USERS_NO_GROUP'] = 'Bitte mindestens eine Gruppe markieren!';
...
$TEXT['ACTIVATED'] = 'Aktivierte';
$TEXT['DEACTIVE'] = 'Deaktiveren'; // new
$TEXT['DEACTIVED'] = 'Deaktivierte'; // new
$TEXT['ADD'] = 'Hinzufügen';
...
$TEXT['MODIFY'] = 'Ändern';
$TEXT['NONE'] = 'Keine';
$TEXT['NONE_ACTIVE_FOUND'] = 'Keine Aktiven Benutzer gefunden';
$TEXT['NONE_INACTIVE_FOUND'] = 'Keine Inaktiven Benutzer gefunden';
...
$TEXT['SHOW_ACTIVED_USER'] = 'Umschalten auf aktive Benutzer!';
$TEXT['SHOW_DEACTIVED_USER'] = 'Umschalten auf deaktiverte Benutzer!';
