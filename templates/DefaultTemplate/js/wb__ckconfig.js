...
CKEDITOR.editorConfig = function( config )
{
  ...
  // Different Toolbars. Remove, add or move 'SomeButton', with the quotes and following comma
    ...
    [
        ...
        { name: 'insert',      items : [ 'Image','Flash','Table','HorizontalRule','Smiley','Emojione','SpecialChar','PageBreak','Iframe' ] },
        '/',
  ...
  config.toolbar_WB_Mini = [
            ...
            ['Styles','Format','Font','FontSize'],['NumberedList','BulletedList','-','Blockquote','CreateDiv'],['Smiley','Emojione'],['About']];
  ...
  config.toolbar_WB_Basic = [
    ...
    [
        ...
        { name: 'insert', items : [ 'Image','Flash','Table','HorizontalRule','Smiley','Emojione','SpecialChar','Iframe','Youtube','oembed', 'slideshow' ] },
        '/',
        { name: 'styles', items : [ 'Styles','Format','Font','FontSize' ] },
        { name: 'colors', items : [ 'TextColor','BGColor' ] },
