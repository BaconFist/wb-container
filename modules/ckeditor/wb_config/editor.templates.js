        ...
        [
            {
                title: '2 Bilder',
                image: '2bilder.gif',
                description: '2 Bilder nebeneiandner (Bootstrap)',
                html:
                    '<div class="col-sm-6 text-center">' +
                      '<img class="img-responsive center-block" src="{SYSVAR:AppUrl.MediaDir}bildplatzhalter.jpg" alt="Bildbeschreibung" />' +
                      '<small>Bildbeschreibung</small>' +
                    '</div>' +
                    '<div class="col-sm-6 text-center">' +
                      '<img class="img-responsive center-block" src="{SYSVAR:AppUrl.MediaDir}bildplatzhalter.jpg" alt="Bildbeschreibung" />' +
                      '<small>Bildbeschreibung</small>' +
