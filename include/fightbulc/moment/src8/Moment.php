...
class Moment extends \DateTime
{
     ...
     * Info {@see https://www.php.net/manual/en/class.datetime.php)
     *
     ...
     *
     */
    public static function createFromFormat($format, $time, $timezone = null, FormatsInterface $formatsInterface = null):\DateTime|false
    {
