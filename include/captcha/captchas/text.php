...
// $Id: text.php 255 2019-03-17 19:12:39Z Luisehahne $
...
$_SESSION['captcha'.$mIdKey] = rand(0,99999);
...
if(!isset($qa) || $qa == []) {
    echo 'Error</b>: no text defined! Enter 0</b> to solve this captcha';
    $_SESSION['captcha'] = '0';
    return;
}
...
$_SESSION['captcha'.$mIdKey] = $qa[$lang][$k];
